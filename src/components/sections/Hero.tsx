            ...
            <div id="hero" className="flex mt-16">
                ...
                <div className="h-full flex flex-row items-center mt-20 mb-10 ml-8 z-10">
                    ...
                    <div className="p-3 pl-32 bg-gradient-to-r to-gray-800 from-gray-700 rounded-2xl ml-32">
                        <h1 className="text-2xl md:text-4xl lg:text-5xl text-gray-50">{t("name")}</h1>
                        <h3 className="text-xl md:text-2xl lg:text-3xl text-gray-200">{t("title")}</h3>
                        <p className="md:text-xl lg:text-2xl text-gray-400">{t("desc")}</p>
                    </div>
                </div>
            </div>
            <span id="about"></span>
